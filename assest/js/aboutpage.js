...
const imageUrls = [
  "./assest/media/about-images-1.png",
  "./assest/media/about-images-2.png",
  "./assest/media/about-images-3.png",
  "./assest/media/about-images-4.png",
  "./assest/media/about-images-5.png",
  "./assest/media/about-images-6.png",
  "./assest/media/about-images-7.png",
  "./assest/media/about-images-8.png",
  "./assest/media/about-images-9.png",
  "./assest/media/about-images-10.png",
];
